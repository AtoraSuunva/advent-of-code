...
// Inspired by https://github.com/seihoukei/aoc_bp/blob/seihoukei_2021/data/2021/19/solver.js
// I was stuck on this for too long, honestly
  ...
  public getResult(): number {
    ...
    for (const scanner of this.scanners) {
      for (const beacon of scanner.beacons) {
        beacons.add(beacon.position.toString())
      }
    }
