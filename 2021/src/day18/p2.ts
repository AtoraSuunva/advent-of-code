...
class BinaryNode extends Node {
  ...
  public clone(): BinaryNode {
    return new BinaryNode(this.left.clone(), this.right.clone())
  }
...
class SnailfishNumber extends BinaryNode {
  constructor(
    left: SnailfishNumber | BinaryNode | ValueNode,
    right: SnailfishNumber | BinaryNode | ValueNode,
  ) {
    super(left, right)
  }
  ...
  public add(value: SnailfishNumber): SnailfishNumber {
    const sn = new SnailfishNumber(this.clone(), value.clone())
    sn.reduce()
    return sn
  }

  public override clone(): SnailfishNumber {
...
const sfNumbers = parsedInput.map((tuple) => SnailfishNumber.fromTuple(tuple))
